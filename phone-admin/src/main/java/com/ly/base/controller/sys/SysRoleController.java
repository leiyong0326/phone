...
import com.ly.base.proxy.sys.SysRoleProxy;
...
public class SysRoleController {
	...
	@ResponseBody
	public Json grantRole(HttpServletRequest request,String menuPks,Integer rolePk){
		return proxy.grantRole(request, menuPks, rolePk);
	}
	/**
	 * 通过主键删除
	 * 
