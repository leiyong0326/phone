...
import com.ly.base.dao.log.LogLoginMapper;
...
public class LogLoginServiceImpl extends BaseServiceImpl<LogLogin> implements LogLoginService {
	...
	@Autowired
	public void setBaseMapper(LogLoginMapper baseMapper) {
		super.setBaseMapper(baseMapper);
	}
	public LogLoginMapper getBaseMapper() {
		return (LogLoginMapper) super.getBaseMapper();
	}
	/**
	 * 通过主键查询
	 * 
