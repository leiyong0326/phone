...
function(r) {
    ...
    function($, fmt, w, utils, Temp, Page, datepicker) {
        ...
        function PageRender(options) {
            ...
            this.dataApi = {
                search: 'logOperater/findByPage',
                // 查询接口
                update: 'logOperater/update',
                // 修改状态
                save: 'logOperater/insert',
                // 修改状态
                enable: 'logOperater/enable',
                // 修改状态
                disable: 'logOperater/disable',
                // 修改状态
                del: 'logOperater/deleteAll',
                // 删除接口
                searchOne: 'logOperater/get'
            };
            // 默认查询参数
            this.searchOptions = {
                pageNum: 1,
