    ...
    require(['jquery','format','warn', 'utils', 'template', 'pagination', 'datetimepicker', 'format',
        ...
        function ($,fmt,w, utils, Temp, Page, datepicker, format) {
            ...
            function PageRender(options) {
                ...
                this.dataApi = {
                    search: 'goodsPhone/findByPage', // 查询接口
                    searchOne: 'goodsPhone/get', // 查询某条数据
                    del: 'goodsPhone/delete', // 删除接口
                    updateSeq: 'goodsPhone/updateSeq' //排序接口
                };
            ...
            PageRender.prototype = {
                ...
                // 初始化添加数据
                add: function () {
                    window.location.href = 'phone_info.html?type=add';
                },

                // 初始化编辑数据
                edit: function (pk) {
                    window.location.href = 'phone_edit_info.html?pk=' + pk;
                },

                // 初始化添加数据
                findImg: function (phonePk) {
                    window.location.href = 'phoneImg_info.html?phonePk=' + phonePk;
                },
...
//                            var obj = $.parseJSON(data).obj;
                            ...
                            that.selects.typePk.html(optionStr);
                        }
                    });
                },
