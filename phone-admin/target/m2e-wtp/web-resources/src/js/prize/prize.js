define([ '../require.config' ], function(r) {
	...
	require([ 'jquery','format', 'utils', 'template', 'pagination', 'datetimepicker', 'navbar', 'amazeui', 'updataFile'], function($,fmt, utils, Temp, Page, datepicker) {
		...
		function PageRender(options) {
			...
			this.addModal.modal({
				...
				onConfirm: function() {
					...
					// 遍历数据
					['name', 'type','price','saleMoney','days','num','useCondition'].map(function(i) {
