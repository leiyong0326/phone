...
function(r) {
    ...
    function($, fmt, w, utils, Temp, Page, datepicker) {
        ...
        function PageRender(options) {
            ...
            this.dataApi = {
                 search: 'sysAccount/findByPage',
                 // 查询接口
                 save: 'sysAccount/insert',
                 del: 'sysAccount/deleteByBatch',
                 searchOne:'sysAccount/get'
            };
            // 默认查询参数
            this.searchOptions = {
                pageNum: 1,
            ...
            this.addModal.modal({
                ...
                onConfirm: function() {
                    if(that.eventType!='show'){
                         // 遍历数据
    		    	$.extend(that.addOptions,utils.getFormData($('[data-content="add-content"]')));
                        that.saveData();
                    }else{
