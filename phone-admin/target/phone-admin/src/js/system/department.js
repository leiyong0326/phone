...
function(r) {
    ...
    function($, fmt, w, utils, Temp, Page, datepicker) {
        ...
        function PageRender(options) {
            ...
            this.dataApi = {
                search: 'sysDepartment/find',
                // 查询接口
                update: 'sysDepartment/update',
                // 修改状态
                save: 'sysDepartment/save',
                // 修改状态
                enable: 'sysDepartment/enable',
                // 修改状态
                disable: 'sysDepartment/disable',
                // 修改状态
                del: 'sysDepartment/deleteAll',
                // 删除接口
                searchOne: 'sysDepartment/get'
            };
            // 默认查询参数
            this.searchOptions = {
                pageNum: 1,
            ...
            this.addModal.modal({
                ...
                onConfirm: function() {
                    if(that.eventType!='show'){
                         // 遍历数据
                        ['name', 'dsc', 'upPk'].map(function(i) {
                            if (i == 'upPk') {
                                that.addOptions[i] = that.addModal.find('[name="upPk"] option:selected').val();
                            }else{
