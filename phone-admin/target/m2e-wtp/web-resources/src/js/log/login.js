...
function(r) {
    ...
    function($, fmt, w, utils, Temp, Page, datepicker) {
        ...
        function PageRender(options) {
            ...
            this.dataApi = {
                search: 'logLogin/findByPage',
                // 查询接口
                update: 'logLogin/update',
                // 修改状态
                save: 'logLogin/insert',
                // 修改状态
                enable: 'logLogin/enable',
                // 修改状态
                disable: 'logLogin/disable',
                // 修改状态
                del: 'logLogin/deleteAll',
                // 删除接口
                searchOne: 'logLogin/get'
            };
            // 默认查询参数
            this.searchOptions = {
                pageNum: 1,
