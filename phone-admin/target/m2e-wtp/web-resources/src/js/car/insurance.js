define([ '../require.config' ], function(r) {
	...
	function PageRender(options) {
	    ...
	    this.dataApi = {
		search : 'insurance/find', // 查询接口
		updateStatus : 'insurance/updateStatus', // 修改状态
		del : 'insurance/delete' // 删除接口
	    };
	    ...
	    // 按钮组合
	    this.elements = {
		search : $('[data-insurance="query"]'),
		del : $('[data-insurance="del"]')
	    };
	...
	PageRender.prototype = {
		...
		this.temp.content.on('click', '.editB', function() {
		    ...
		    // 报价
		    window.location.href = 'insurance_info.html?id=' + _pk;
		    
//		    if (_isAjax) {
//			utils.ajax({
//			    url : that.dataApi.updateStatus,
//			    data : {
//				pk : _pk,
//				status : _status
//			    },
