...
import com.ly.base.core.provide.log.LogLoginService;
 ...
 */
@Component
public class LogLoginConsumerServiceImpl implements LogLoginConsumerService {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Select, title = "#pk")
	public Json getByPk(Integer pk) {
		Json json = new Json();
		LogLogin result = service.selectByPrimaryKey(pk);
		if (result == null) {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Delete, title = "#pk")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Delete, title = "#pks?.![#this]")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Update, title = "#pk")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Update, title = "#pks?.![#this]")
	...
	public Json insert(LogLogin data) {
		Json json = new Json();
		LogLogin result = service.insertSelective(data);
		if (result == null) {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Save, title = "#objs?.!['1']")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Update, title = "#data?.pk")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.LogLogin, type = LogOperateEnum.Select, title = "")
	public Json findByPage(LogLogin queryInfo, int pageNum, int pageSize,String orderBy) {
		Json json = new Json();
		Page<LogLogin> result = service.findByPage(queryInfo,pageNum,pageSize,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
	...
	public Json findAll(LogLogin queryInfo, String orderBy) {
		Json json = new Json();
		Page<LogLogin> result = service.findAll(queryInfo,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result);
	...
	public Json findByPage(List<Model> conditions, int pageNum, int pageSize,String orderBy) {
		Json json = new Json();
		Page<LogLogin> result = service.findByPage(conditions,pageNum,pageSize,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result).setTotal(result.getPages());
	...
	public Json findAll(List<Model> conditions, String orderBy) {
		Json json = new Json();
		Page<LogLogin> result = service.findAll(conditions,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result);
