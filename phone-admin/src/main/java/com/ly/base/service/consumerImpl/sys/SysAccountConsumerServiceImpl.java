 ...
 */
@Component
public class SysAccountConsumerServiceImpl implements SysAccountConsumerService {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Select, title = "#pk")
	public Json getByPk(Integer pk) {
		Json json = new Json();
		SysAccount result = service.selectByPrimaryKey(pk);
		if (result == null) {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Delete, title = "#pk")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Delete, title = "#pks?.![#this]")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Update, title = "#pk")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Update, title = "#pks?.![#this]")
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Save, title = "#data?.pk")
	public Json insert(SysAccount data) {
		Json json = new Json();
		SysAccount result = service.insertSelective(data);
		if (result == null) {
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Save, title = "#objs?.!['1']")
	public Json insertBatch(List<SysAccount> list) {
		Json json = new Json();
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Update, title = "#data?.pk")
	public Json update(SysAccount data) {
		Json json = new Json();
	 ...
	 */ 
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Select, title = "")
	public Json findByPage(SysAccount queryInfo, int pageNum, int pageSize,String orderBy) {
		Json json = new Json();
		Page<SysAccount> result = service.findByPage(queryInfo,pageNum,pageSize,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
	...
	@Override
	@Logger(model = LogEnum.SysAccount, type = LogOperateEnum.Select, title = "")
	public Json findAll(SysAccount queryInfo, String orderBy) {
		Json json = new Json();
		Page<SysAccount> result = service.findAll(queryInfo,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result);
	...
	public Json findByPage(List<Model> conditions, int pageNum, int pageSize,String orderBy) {
		Json json = new Json();
		Page<SysAccount> result = service.findByPage(conditions,pageNum,pageSize,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result).setTotal(result.getPages());
	...
	public Json findAll(List<Model> conditions, String orderBy) {
		Json json = new Json();
		Page<SysAccount> result = service.findAll(conditions,orderBy);
		if (result == null) {
			return ErrorConfig.getSystemErrorJson();
		}
		json.setSuccess(true).setObj(result);
